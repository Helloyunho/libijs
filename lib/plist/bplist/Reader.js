...
class Reader {
  ...
  read () {
    ...
    if (bplistFormat.version.compare(this.__buffer, bufferVersionOffset, bufferVersionOffset + bplistFormat.version.length) !== 0) {
      return null
    }
  ...
  static isBinaryPlist (buffer) {
    ...
    return (bplistFormat.magic.compare(buffer, 0, bplistFormat.magic.length) === 0)
  }
